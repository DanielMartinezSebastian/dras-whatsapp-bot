...
describe('MessageProcessorService', () => {
  ...
  beforeEach(() => {
    ...
    mockWhatsAppBridge = WhatsAppBridgeService.getInstance() as jest.Mocked<WhatsAppBridgeService>;
    ...
    mockWhatsAppBridge.sendTextMessage.mockResolvedValue(true);
    mockWhatsAppBridge.sendMediaMessage.mockResolvedValue(true);
  });
  ...
  describe('Message Processing Pipeline', () => {
    const createTestMessage = (overrides: Partial<IncomingMessage> = {}): IncomingMessage => ({
      id: 'msg_123',
    ...
    describe('Message Validation', () => {
      ...
      it('should reject message without content', async () => {
        ...
        expect(result.errors).toBeDefined();
        expect(result.errors!).toHaveLength(1);
        expect(result.errors![0].message).toContain('missing sender or content');
      });
    ...
    describe('Command Processing', () => {
      ...
      it('should handle commands with arguments', async () => {
        const message = createTestMessage({ content: '!config set language es' });
    ...
    describe('Response Generation', () => {
      ...
      it('should handle response sending errors gracefully', async () => {
        mockWhatsAppBridge.sendTextMessage.mockRejectedValue(new Error('Network error'));
